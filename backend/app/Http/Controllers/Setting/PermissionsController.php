...
class PermissionsController extends Controller {      
  ...
  { 
    $this->hasPermissionTo('SETTING-PENGGUNA-PERMISSIONS_BROWSE');
  ...
  {
      $this->hasPermissionTo('SETTING-PENGGUNA-PERMISSIONS_STORE');
  ...
  {
      $this->hasPermissionTo('SETTING-PENGGUNA-PERMISSIONS_DESTROY');
