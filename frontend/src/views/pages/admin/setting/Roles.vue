		...
		<ModuleHeader>
			...
			<template v-slot:desc>
				<v-alert color="cyan" border="left" colored-border type="info">
					Masing-masing user bisa memiliki beberapa role, minimal 1 role untuk
					bisa menggunakan sistem. Setiap role memiliki permission.
				</v-alert>
			</template>
		</ModuleHeader>
		<v-container fluid>
	...
	export default {
		...
		methods: {
			...
			viewItem(item) {
				...
				this.$ajax
					.get("/setting/setting/roles/" + item.id + "/permission", {
						headers: {
							Authorization: this.TOKEN,
						},
					})
			...
			save() {
				...
				if (this.$refs.frmdata.validate()) {
					...
					if (this.editedIndex > -1) {
						this.$ajax
							.post(
								"/setting/setting/roles/" + this.editedItem.id,
								{
									_method: "PUT",
