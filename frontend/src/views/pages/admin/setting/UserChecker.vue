    ...
    <ModuleHeader>
      ...
      <template v-slot:desc>
        <v-alert color="cyan" border="left" colored-border type="info">
          User dengan role CHECKER bertanggungjawab terhadap proses
          ...
          >
            <template v-slot:top>
              <v-toolbar flat color="white">
                <v-toolbar-title>DAFTAR USERS CHECKER</v-toolbar-title>
                ...
                <v-tooltip bottom>
                  <template v-slot:activator="{ on, attrs }">
                    <v-btn
                      ...
                      class="ma-2"
                      :disabled="btnLoading"
                      @click.stop="showDialogTambahUserChecker"
                    >
                      <v-icon>mdi-plus</v-icon>
                    </v-btn>
                  </template>
                  <span>Tambah User Checker</span>
                </v-tooltip>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showDialogTambahUserChecker: async function() {
        this.dialog = true;				
      },
