			...
			<div class="row">
				<div class="col-lg-12">
					<div class="text-center mt-sm-5 mb-4 text-white-50">
						...
						<p class="mt-3 fs-15 fw-medium">Sistem Informasi Resi</p>
					</div>
				</div>
			</div>
			<!-- end row -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="text-center">
						<p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Siresi. Crafted with <i class="mdi mdi-heart text-danger"></i> by Yacanet</p>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin/projects/siresi/resources/views/auth/login.blade.php ENDPATH**/ ?>