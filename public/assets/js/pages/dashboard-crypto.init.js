...
chart.render(); // Market Chart Candalstick
...
var swiper = new Swiper(".cryptoSlider", {
  ...
  breakpoints: {
    ...
    768: {
      slidesPerView: 2.5 // spaceBetween: 24,
