...
var options = {
  valueNames: ["id", "name", "owner", "industry_type", "star_value", "location"],
  page: perPage,
  pagination: true,
...
addBtn.addEventListener("click", function (e) {
  if (customerNameField.value !== "" && ownerField.value !== "" && industry_typeField.value !== "" && star_valueField.value !== "" && locationField.value !== "") {
    companyList.add({
