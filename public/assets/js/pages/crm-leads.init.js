...
var options = {
  valueNames: ["id", "name", "company_name", "date", "leads_score", "phone", "location"],
  page: perPage,
  pagination: true,
...
addBtn.addEventListener("click", function (e) {
  if (customerNameField.value !== "" && company_nameField.value !== "" && dateField.value !== "" && leads_scoreField.value !== "" && phoneField.value !== "" && locationField.value !== "") {
    leadsList.add({
