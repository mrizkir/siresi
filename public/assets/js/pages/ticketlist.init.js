...
function updateList() {
  ...
  userList.update(); //console.log('Filtered: ' + values_gender);
}
...
var table = document.getElementById("ticketTable"); // save all tr
...
addBtn.addEventListener("click", function (e) {
  if (tasksTitleField.value !== "" && clientNameField.value !== "" && assignedtoNameField.value !== "" && dateField.value !== "" && dateDueField.value !== "" && statusField.value !== "" && priorityField.value !== "") {
    ticketsList.add({
      id: '<a href="javascript:void(0);" class="fw-medium link-primary">#VLZ' + count + "</a>",
