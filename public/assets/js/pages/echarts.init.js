...
option && myChart.setOption(option); // area chart
...
option && myChart.setOption(option); // area stacked chart
...
option && myChart.setOption(option); // chart-step-line
...
option && myChart.setOption(option); //chart-line-y-category
...
option && myChart.setOption(option); // chart-bar
...
option && myChart.setOption(option); // chart-bar-label-rotation
...
option && myChart.setOption(option); // chart-horizontal-bar
...
option && myChart.setOption(option); // chart-horizontal-bar-stacked
...
option && myChart.setOption(option); // Pie charts
...
option && myChart.setOption(option); // chart doughnut
...
option && myChart.setOption(option); // Basic Scatter Chart
...
option && myChart.setOption(option); // chart-candlestick
...
option && myChart.setOption(option); // Graph chart
...
option && myChart.setOption(option); // chart treemap
...
option && myChart.setOption(option); // chart-sunburst
...
option && myChart.setOption(option); // Parallel
...
option && myChart.setOption(option); // sankey chart
...
option && myChart.setOption(option); // funnel chart
...
option && myChart.setOption(option); // Simple Gauge
...
option && myChart.setOption(option); // Calendar Heatmap
