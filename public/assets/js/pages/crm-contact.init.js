...
var options = {
  valueNames: ["id", "name", "company_name", "date", "email_id", "phone", "lead_score"],
  page: perPage,
  pagination: true,
...
addBtn.addEventListener("click", function (e) {
  if (customerNameField.value !== "" && company_nameField.value !== "" && email_idField.value !== "" && phoneField.value !== "" && lead_scoreField.value !== "") {
    contactList.add({
