                                    ...
                                    <div class="col-xl-4 col-lg-10">
                                        <div class="row g-2">
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a src="{{ URL::asset('assets/images/small/img-1.jpg') }}" class="image-popup d-block">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a src="{{ URL::asset('assets/images/small/img-3.jpg') }}" class="image-popup d-block">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a src="{{ URL::asset('assets/images/small/img-4.jpg') }}" class="image-popup d-block">
                            ...
                            <div class="gallery-light">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-1.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-2.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-3.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-4.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-5.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-6.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-7.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-8.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-9.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-10.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-11.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" src="{{ URL::asset('assets/images/small/img-12.jpg') }}" title="">
