...
@section('content')
    ...
    <div class="tasks-board mb-3" id="kanbanboard">
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">Unassigned <small class="badge bg-success align-bottom ms-1">2</small></h6>
                </div>
                ...
                <div id="unassigned-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-14 mb-0 flex-grow-1 text-truncate"><a href="apps-tasks-details" class="text-body">Profile Page Structure</a></h6>
                                <div class="dropdown">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 mb-0 flex-grow-1 text-truncate"><a href="apps-tasks-details" class="text-body">Velzon - Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">To Do <small class="badge bg-secondary align-bottom ms-1">2</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div id="todo-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 mb-0 text-truncate"><a href="apps-tasks-details" class="text-body">Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 mb-0 text-truncate"><a href="apps-tasks-details" class="text-body">Marketing & Sales</a></h6>
                                </div>
                                <div class="flex-shrink-0">
        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">Inprogress <small class="badge bg-warning align-bottom ms-1">2</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Brand Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Change Old App Icon</a></h6>
        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">In Reviews <small class="badge bg-info align-bottom ms-1">3</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Create Product Animations</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Product Features Analysis</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Create a Graph of Sketch</a></h6>
        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">Completed <small class="badge bg-success align-bottom ms-1">1</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                <div id="completed-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-14 mb-0 flex-grow-1 text-truncate"><a href="apps-tasks-details" class="text-body">Create a Blog Template UI</a></h6>
                                <div class="dropdown">
        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-13 text-uppercase mb-0">new <small class="badge bg-success align-bottom ms-1">1</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-14 text-truncate"><a href="apps-tasks-details" class="text-body">Banner Design for FB & Twitter</a></h6>
