            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('assets/images/small/img-10.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
            ...
            <div class="row">
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('assets/images/small/img-12.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('assets/images/small/img-9.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('assets/images/small/img-2.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" class="flex-shrink-0 me-3 avatar-xl rounded" alt="..." />
                                <div>
