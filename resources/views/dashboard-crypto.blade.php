                        ...
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-medium fs-12 text-muted mb-1">Total Invested</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-medium fs-12 text-muted mb-1">Total Change</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-medium fs-12 text-muted mb-1">Day Change</p>
                                    <h4 class=" mb-0">$<span class="counter-value" data-target="14799.44">0</span></h4>
                                 </div>
                                 <div class="flex-shrink-0 align-self-end">
                                     <span class="badge badge-soft-danger"><i class="ri-arrow-down-s-fill align-middle me-1"></i>4.80 %<span>
                                 </span></span></div>
                             </div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('assets/images/svg/crypto-icons/etc.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('assets/images/svg/crypto-icons/bnb.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('assets/images/svg/crypto-icons/usdt.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('assets/images/svg/crypto-icons/bnb.svg') }}" alt="" class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('assets/images/svg/crypto-icons/usdt.svg') }}" alt="" class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('assets/images/svg/crypto-icons/doge.svg') }}" alt="" class="avatar-xxs">
                                            </div>
                                            <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" class="rounded img-fluid" style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" class="rounded img-fluid" style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" class="rounded img-fluid" style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-6.jpg') }}" class="rounded img-fluid" style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
