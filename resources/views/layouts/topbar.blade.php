            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        @case('ru')
                            <img src="{{ URL::asset('/assets/images/flags/russia.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @case('it')
                            <img src="{{ URL::asset('/assets/images/flags/italy.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @case('sp')
                            <img src="{{ URL::asset('/assets/images/flags/spain.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @case('ch')
                            <img src="{{ URL::asset('/assets/images/flags/china.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @case('fr')
                            <img src="{{ URL::asset('/assets/images/flags/french.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @case('gr')
                            <img src="{{ URL::asset('/assets/images/flags/germany.svg') }}" class="me-2 rounded" height="18" alt="Header Language"
                                >
                        @break
                        @default
                            <img src="{{ URL::asset('/assets/images/flags/us.svg') }}" class="me-2 rounded" height="18" alt="Header Language" height="16">
                    @endswitch
                    </button>
